...
import springMVC.validator.CustomerInfoValidator;
...
public class MainController {
    ...
    public String listProductHandler(Model model, //
        ...
        final int maxNavigationPage = 25;
    ...
    @RequestMapping(value = {
            "/shoppingCartCustomer" }, method = RequestMethod.GET)
    ...
    @RequestMapping(value = {
            "/shoppingCartCustomer" }, method = RequestMethod.POST)
    ...
    @RequestMapping(value = {
            "/shoppingCartConfirmation" }, method = RequestMethod.GET)
    ...
    @RequestMapping(value = {
            "/shoppingCartConfirmation" }, method = RequestMethod.POST)
    ...
    @RequestMapping(value = {
            "/shoppingCartFinalize" }, method = RequestMethod.GET)
